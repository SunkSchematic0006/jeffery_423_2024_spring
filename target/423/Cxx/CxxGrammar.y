 ...
 *
 * hacked by jeffery.
 * bruce force attempt to compile as-is.
 * %union added with the field names (but not the types)
 * implied by all the <declarations>
 */
%union {
   int keyword;
...
id:                                 identifier                          %prec SHIFT_THERE       /* Force < through test */
    ...
    |                               template_id 
template_test:                      '<'             /* Queue '+' or '-' < as follow on */       { semantic_error("C++ operation not supported"); }
global_scope:                       SCOPE
...
type1_parameters:       /*----*/    parameter_declaration_list ';'
    |                   /*----*/    type1_parameters parameter_declaration_list ';'
mark_type1:                         /* empty */                                             { semantic_error("C++ operation not supported"); yyclearin; }
 ...
 */
looping_statement:                  start_search looped_statement                               { semantic_error("C++ operation not supported"); }
...
compound_statement:                 '{' statement_seq.opt '}'
    |                               '{' statement_seq.opt looping_statement '#' bang error '}'  { semantic_error("C++ operation not supported"); }
 ...
 * A.6 Declarations
 *---------------------------------------------------------------------------------------------------*/
compound_declaration:               '{' nest declaration_seq.opt '}'                            { semantic_error("C++ operation not supported"); }
...
declaration_seq.opt:                /* empty */
    ...
    |                               declaration_seq.opt util looping_declaration '#' bang error ';' { semantic_error("C++ operation not supported"); }
looping_declaration:                start_search1 looped_declaration                            { semantic_error("C++ operation not supported"); }
...
enumerator_list_ecarb:              '}'
    |                               bang error '}'                                              { semantic_error("C++ operation not supported"); }
...
braced_initializer:                 '{' initializer_list '}'
    |                               '{' initializer_list ',' '}'
    |                               '{' '}'
    |                               '{' looping_initializer_clause '#' bang error '}'           { semantic_error("C++ operation not supported"); }
    |                               '{' initializer_list ',' looping_initializer_clause '#' bang error '}'
                                                                                                { semantic_error("C++ operation not supported"); }
initializer_list:                   looping_initializer_clause
    |                               initializer_list ',' looping_initializer_clause
    ;
looping_initializer_clause:         start_search looped_initializer_clause                      { semantic_error("C++ operation not supported"); }
 ...
 */
colon_mark:                         ':'                                                         { semantic_error("C++ operation not supported"); }
elaborated_class_specifier:         class_key scoped_id                    %prec SHIFT_THERE
    |                               class_key scoped_id colon_mark error                        { semantic_error("C++ operation not supported"); }
class_specifier_head:               class_key scoped_id colon_mark base_specifier_list '{'      { semantic_error("C++ operation not supported"); }
...
member_specification.opt:           /* empty */
    ...
    |                               member_specification.opt util looping_member_declaration '#' bang error ';'
                                                                                                { semantic_error("C++ operation not supported"); }
looping_member_declaration:         start_search looped_member_declaration                      { semantic_error("C++ operation not supported"); }
...
ctor_initializer:                   ':' mem_initializer_list
    |                               ':' mem_initializer_list bang error                         { semantic_error("C++ operation not supported"); }
 ...
 *---------------------------------------------------------------------------------------------------*/
advance_search:                     error               { yyerrok; yyclearin; semantic_error("C++ operation not supported"); } /* Rewind and queue '+' or '-' '#' */       
bang:                               /* empty */         { semantic_error("C++ operation not supported"); }   /* set flag to suppress "parse error" */ 
mark:                               /* empty */         { semantic_error("C++ operation not supported"); }        /* Push lookahead and input token stream context onto a stack */
nest:                               /* empty */         { semantic_error("C++ operation not supported"); }        /* Push a declaration nesting depth onto the parse stack */
start_search:                       /* empty */         { semantic_error("C++ operation not supported"); }    /* Create/reset binary search context */
start_search1:                      /* empty */         { semantic_error("C++ operation not supported"); }     /* Create/reset binary search context */
