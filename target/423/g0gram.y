...
%type < node > ReturnStatement <FONT  COLOR="#FF0000">ThrowStatement SynchronizedStatement</FONT>
%type < node > <FONT  COLOR="#FF0000">TryStatement Catches CatchClause </FONT>Finally Primary
...
%type < node > <FONT  COLOR="#FF0000">ThrowsOpt </FONT>FormalParameterListOpt IDENTOpt CatchesOpt
...
Modifier:	  PUBLIC
		...
		| FINAL
		| NATIVE
		| <FONT  COLOR="#FF0000">SYNCHRONIZED</FONT>
		| TRANSIENT
		| VOLATILE
		;
...
StatementWithoutTrailingSubstatement: Block
		...
		| ContinueStatement
		| ReturnStatement
		| <FONT  COLOR="#FF0000">SynchronizedStatement
		| ThrowStatement
		| TryStatement
</FONT>		;
