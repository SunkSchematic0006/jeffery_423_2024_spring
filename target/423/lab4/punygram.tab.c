...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_5_ = 5,                         /* ';'  */
  YYSYMBOL_compound_stmt = 6,              /* compound_stmt  */
  YYSYMBOL_small_stmt = 7,                 /* small_stmt  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_file_input = 9,                 /* file_input  */
  YYSYMBOL_file_input_prime = 10,          /* file_input_prime  */
  YYSYMBOL_stmt = 11,                      /* stmt  */
  YYSYMBOL_simple_stmt = 12,               /* simple_stmt  */
  YYSYMBOL_small_stmts = 13,               /* small_stmts  */
  YYSYMBOL_optional_semicolon = 14         /* optional_semicolon  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ENDMARKER", "NEWLINE",
  "';'", "compound_stmt", "small_stmt", "$accept", "file_input",
  "file_input_prime", "stmt", "simple_stmt", "small_stmts",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* file_input_prime: %empty  */
#line 38 "punygram.y"
                   { (yyval.treeptr)=NULL; }
#line 1086 "punygram.tab.c"
    break;

  case 11: /* small_stmts: %empty  */
#line 42 "punygram.y"
              { (yyval.treeptr)=NULL; }
#line 1092 "punygram.tab.c"
    break;

  case 13: /* optional_semicolon: %empty  */
#line 43 "punygram.y"
                          { (yyval.treeptr)=NULL; }
#line 1098 "punygram.tab.c"
    break;


#line 1102 "punygram.tab.c"
